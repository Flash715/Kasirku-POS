    ...
    private void exportreport() {
        bexport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                laporanfile = new File(Environment.getExternalStorageDirectory(), "kasirkubackup/laporan/margin-" + ddari + "-" + dhingga + ".csv");
                ...
                try {
                    ...
                    query = "SELECT pjm.tanggal_penjualan,pjd.kode_penjualan_master,pjd.kode_barang,ps.nama_barang," +
                            ...
                            "ORDER BY pjm.date_created DESC";
                    Cursor c = db.rawQuery(query, null);
                    sb.append("Tanggal Transaksi,Kode Transaksi,Kode Barang,Nama Barang,Jumlah Terjual,Satuan,Diskon,Total Harga Jual,Total Harga Modal,Laba");
                    sb.append("\n");
                    while (c.moveToNext()) {
