...
public class LaporanPembelianActivity extends AppCompatActivity {
        ...
        bexport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    query = "SELECT pbm.tanggal_pembelian,pbd.kode_pembelian_master,pbd.kode_barang,ps.nama_barang,pbd.jumlah,pbd.harga_beli,pbd.jumlah*pbd.harga_beli from pembelian_detail pbd " +
                            "INNER JOIN persediaan ps ON ps.kode_barang=pbd.kode_barang " +
                            "INNER JOIN pembelian_master pbm ON pbm.kode_pembelian_master=pbd.kode_pembelian_master " +
    ...
    public class reportadapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View v = convertView;
            if (v == null) {
                v = LayoutInflater.from(ct).inflate(R.layout.adapter_laporan_pembelian, parent, false);
