    ...
    private void gettanggal() {
        bimg_tanggal_dari.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog dpd = new DatePickerDialog(com.ivan.kasirku.LaporanStokActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void exportreport() {
        bexport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(com.ivan.kasirku.LaporanStokActivity.this, android.Manifest.permission.READ_EXTERNAL_STORAGE)
                        != PackageManager.PERMISSION_GRANTED &&
                        ActivityCompat.checkSelfPermission(com.ivan.kasirku.LaporanStokActivity.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                                != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(com.ivan.kasirku.LaporanStokActivity.this,
                ...
                try {
                    ...
                    adb.setPositiveButton("Buka File", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            try {
                                ...
                                Toast.makeText(LaporanStokActivity.this, ex.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                    ...
                    Toast.makeText(LaporanStokActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
