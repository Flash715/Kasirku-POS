...
public class LaporanStokActivity extends AppCompatActivity {
    ...
    private void loadreport() {
        ...
        String query = "";
        query = "SELECT kode_barang,nama_barang,satuan_barang,jumlah_barang FROM persediaan ORDER BY jumlah_barang DESC";
    ...
    private void gettanggal() {
        bimg_tanggal_dari.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog dpd = new DatePickerDialog(com.dfit.dfpos.LaporanStokActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void exportreport() {
        bexport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(com.dfit.dfpos.LaporanStokActivity.this, android.Manifest.permission.READ_EXTERNAL_STORAGE)
                        != PackageManager.PERMISSION_GRANTED &&
                        ActivityCompat.checkSelfPermission(com.dfit.dfpos.LaporanStokActivity.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                                != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(com.dfit.dfpos.LaporanStokActivity.this,
                ...
                laporanfile = new File(Environment.getExternalStorageDirectory(),
                        "kasirkubackup/laporan/penjualan-" + ddari + "-" + dhingga + ".csv");
                ...
                try {
                    ...
                    AlertDialog.Builder adb = new AlertDialog.Builder(com.dfit.dfpos.LaporanStokActivity.this);
                    ...
                    adb.setPositiveButton("Buka File", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            try {
                                ...
                                Toast.makeText(com.dfit.dfpos.LaporanStokActivity.this, ex.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                    ...
                    Toast.makeText(com.dfit.dfpos.LaporanStokActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
    ...
    public class reportadapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View v = convertView;
            if (v == null) {
                v = LayoutInflater.from(ct).inflate(R.layout.adapter_laporan_stok, parent, false);
