        ...
        rvdata.addOnScrollListener(new EndlessScroll() {
            ...
            public void onLoadMore() {
                if (svdata.getQuery() == null || (svdata.getQuery().toString().equals(""))) {
                    Toast.makeText(com.dfit.dfpos.PersediaanActivity.this, "memuat data", Toast.LENGTH_SHORT).show();
                    loaddata();
        ...
        fbadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(sp.getInt("write_persediaan",0)==1) {
                    Intent in = new Intent(com.ivan.kasirku.PersediaanActivity.this, TambahPersediaanActivity.class);
                    startActivity(in);
                }else{
                    Toast.makeText(com.ivan.kasirku.PersediaanActivity.this, "Proses Ditolak, Anda tidak memiliki akses", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public class PersediaanAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
            if (holder instanceof Holder) {
                ...
                h.lharga_beli.setText("Beli : " + nf.format(model.get(position).getHarga_beli()));
                h.lharga_jual.setText("Jual : " + nf.format(model.get(position).getHarga_jual())+"/"+nf.format(model.get(position).getDiskon())+"%");
